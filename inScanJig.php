...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$serial || !$description || !$customer || !$model || !$area || !$line || $usage === '' || !$remark) {
    ...
    try {
        ...
        $sql = "INSERT INTO transactionincoming 
            (item_id, serial_number, item_description, customer, model, area, line, usage_count, remarks, transaction_date)
            VALUES (:item_id, :serial, :description, :customer, :model, :area, :line, :usage, :remarks, NOW())
